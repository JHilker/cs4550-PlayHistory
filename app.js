...
var playsController   = require('./controllers/plays');
var friendsController = require('./controllers/friends');
var creditsController = require('./controllers/credits');
...
app.post('/account/games/remove', passportConf.isAuthenticated, userController.removeGame);
